...
load_from = 'Configs//rtmpose-l_simcc-aic-coco_pt-aic-coco_420e-256x192-f016ffe0_20230126.pth'
fp16 = dict(loss_scale='dynamic') 

dataset_type = 'CocoDataset'
data_mode = 'topdown'
data_root = 'Ear210_Keypoint_Dataset_coco/'
work_dir = 'Models//RTMPose'
...
default_hooks = {
    'checkpoint': {'save_best': 'PCK','rule': 'greater','max_keep_ckpts': 0},
    'logger': {'interval': 1}
}
